...
from Suporte_automatico.suporte_funcoes import support_geico
...
class LoginGeico:
    ...
    def login_button(self):
        support_geico(self.username_entry.get(), self.password_entry.get(), self.message_entry.get(), nome=self.nome_entry.get())
        self.window.destroy()

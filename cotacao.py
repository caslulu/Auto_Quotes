...
class Cotacao():
    def geico(self, playwright, zipcode, first_name, last_name, date_birth, address, vin, email, financiado):
    ...
    def progressive_support(self, playwright, mensagem, user, password):
